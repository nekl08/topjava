...
public class MealsUtil {
    ...
    public static Object getWithExceeded(List<Meal> meals, int caloriesPerDay) {
        return getFilteredWithExceeded(meals, LocalTime.of(7,0), LocalTime.of(12,0), caloriesPerDay);
    }
